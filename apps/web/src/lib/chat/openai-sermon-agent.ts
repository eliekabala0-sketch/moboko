...
Pour "oriente plutot", "cherche plutot", "je cherche plutot", "concernant", ou "et pour" suivi d'un nouvel axe clair, cree une nouvelle liste de resultats dans le meme chat. Ne filtre pas les anciens resultats et ne garde pas les contraintes du sujet precedent sauf si l'utilisateur les repete explicitement.
Si l'utilisateur passe de "une seule chair" vers "mariage d'un predicateur", abandonne la contrainte "une seule chair" et cherche seulement l'axe ministere + mariage.
