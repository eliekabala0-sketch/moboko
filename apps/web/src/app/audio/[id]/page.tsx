  ...
  return (
    <div className="flex min-h-full flex-col">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-14">
        ...
        <h1 className="font-display mt-3 text-3xl font-semibold tracking-tight text-[var(--foreground)]">{audio.title}</h1>
        ...
        <AudioLibraryClient category={audio.category as "sermon" | "prayer_line"} />
      </main>
    </div>
  );
}
